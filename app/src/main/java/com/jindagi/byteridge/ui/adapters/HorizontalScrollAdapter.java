 ...
 */
public class HorizontalScrollAdapter extends RecyclerView.Adapter<CustomViewHolders> {

    private List<JsonObject> itemList;
    private Context context;

    public HorizontalScrollAdapter(Context context, List<JsonObject> itemList) {
    ...
    public CustomViewHolders onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View layoutView = LayoutInflater.from(parent.getContext()).inflate(R.layout.horizontal_list, null);
